...
// FIX: Converted to a functional component for consistent usage and to accept props.
...
// FIX: Converted to a functional component to be used as a JSX component.
...
// FIX: Converted to a functional component for consistent usage.
...
// FIX: Converted to a functional component to be used as a JSX component with props.
...
export const stats = [
    { icon: <UsersIcon className="text-blue-500"/>, iconBgColor: 'bg-blue-100', value: 847, label: 'Active Meetings', change: '+12%' },
    { icon: <CalendarIcon className="text-purple-500"/>, iconBgColor: 'bg-purple-100', value: 234, label: 'Events Recorded', change: '+8%' },
    { icon: <DocumentIcon className="text-green-500"/>, iconBgColor: 'bg-green-100', value: 156, label: 'Policy Documents', status: 'Updated' },
    { icon: <ChartIcon className="text-orange-500"/>, iconBgColor: 'bg-orange-100', value: '98%', label: 'Efficiency Rate', change: '+24%' },
];
  
export const features = [
    { icon: <MicIcon className="text-blue-500"/>, iconBgColor: 'bg-blue-100', title: 'Automated Minutes', description: 'AI-powered transcription and summarization.' },
    { icon: <ArchiveIcon className="text-purple-500"/>, iconBgColor: 'bg-purple-100', title: 'Digital Archives', description: 'Secure, searchable repository for all records.' },
    { icon: <ShieldIcon className="text-orange-500"/>, iconBgColor: 'bg-orange-100', title: 'Policy Management', description: 'Version control and compliance tracking.' },
];